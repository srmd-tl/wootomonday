...
function update_item_in_monday($itemId, $orderData)
{
    ...
    curl_setopt_array($curl, [
        ...
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
        CURLOPT_CUSTOMREQUEST => "POST",
        CURLOPT_POSTFIELDS => "{\n  \"query\": \"mutation {change_multiple_column_values (item_id:" . $itemId . ",board_id: 1158941214, column_values: \\\"{\\\\\\\"text8\\\\\\\":\\\\\\\"" . $orderId . "\\\\\\\",\\\\\\\"dup__of_reg_name7\\\\\\\":\\\\\\\"" . $lifeStage . "\\\\\\\",\\\\\\\"long_text00\\\\\\\":\\\\\\\"" . $description . "\\\\\\\",\\\\\\\"text\\\\\\\":\\\\\\\"" . $customerFirstName . "\\\\\\\",\\\\\\\"text1\\\\\\\":\\\\\\\"" . $customerLastName . "\\\\\\\",\\\\\\\"date4\\\\\\\":\\\\\\\"" . $createdAt . "\\\\\\\",\\\\\\\"status\\\\\\\":\\\\\\\"" . $status . "\\\\\\\",\\\\\\\"text0\\\\\\\":\\\\\\\"" . $productName . "\\\\\\\",\\\\\\\"long_text8\\\\\\\":\\\\\\\"" . $regName . "\\\\\\\",\\\\\\\"dup__of_reg_name3\\\\\\\":\\\\\\\"" . $year . "\\\\\\\",\\\\\\\"dup__of_birth_year\\\\\\\":\\\\\\\"" . $color . "\\\\\\\",\\\\\\\"dup__of_color\\\\\\\":\\\\\\\"" . $sex . "\\\\\\\",\\\\\\\"dup__of_reg_name\\\\\\\":\\\\\\\"" . $sire . "\\\\\\\",\\\\\\\"dup__of_sire\\\\\\\":\\\\\\\"" . $dam . "\\\\\\\",\\\\\\\"long_text\\\\\\\":\\\\\\\"" . $eligibleIncentives . "\\\\\\\",\\\\\\\"email\\\\\\\":{\\\\\\\"email\\\\\\\":\\\\\\\"" . $customerEmail . "\\\\\\\",\\\\\\\"text\\\\\\\":\\\\\\\"" . $customerEmail . "\\\\\\\"}}\\\") {id}}\"\n}\n",
        CURLOPT_HTTPHEADER => [
            "API-Version: 2023-10",
            "Authorization: eyJhbGciOiJIUzI1NiJ9.eyJ0aWQiOjMwMzk4ODU0MCwiYWFpIjoxMSwidWlkIjo1MTExNjAwMiwiaWFkIjoiMjAyMy0xMi0yMFQxMToyODoyNS43OTdaIiwicGVyIjoibWU6d3JpdGUiLCJhY3RpZCI6Nzg4ODgyOSwicmduIjoidXNlMSJ9.pC8ks0oxDJDykIGkb7s5-y6KyIKfcArV9PR2kytwTZ8",
            "Content-Type: application/json",
